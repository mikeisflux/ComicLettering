...
export const BLOG_POSTS: BlogPost[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { ul: [
        "US standard full bleed: 6.875 × 10.4375 inches.",
        "Trim: 6.625 × 10.1875 inches — the intended final page size.",
        "Safe area: 6.125 × 9.6875 inches — all lettering lives here.",

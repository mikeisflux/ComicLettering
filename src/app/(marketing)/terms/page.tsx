...
export default function Terms() {
  return (
    <main className="mktSection prose">
      ...
      <p>Access costs $160 per year billed through PayPal, or a one-time payment for a 3-month pass ($40), 6-month pass ($80) or lifetime access ($500). Subscriptions renew automatically until cancelled; passes and lifetime purchases never renew. Subscribers who joined on the retired $20/month plan keep that plan and price until they cancel. You can cancel at any time from your PayPal account; access continues until the end of the paid period. There are no free trials. Fees already paid are non-refundable except where required by law.</p>

...
const FAQS: [string, string][] = [
  ...
  ["What fonts are included?", "Nineteen comic-appropriate fonts are built in: dialogue faces like Comic Neue, Patrick Hand and Kalam; display faces like Bangers, Luckiest Guy, Alfa Slab One and Bungee; themed faces like Creepster, Nosifer and Audiowide; plus classic system stacks. All bundled fonts are properly licensed."],

...
const FAQS: [string, string][] = [
  ["What is LetterMyComic?", "LetterMyComic is professional comic lettering software that runs entirely in your web browser. You get word balloons with draggable tails, SFX lettering styles, comic fonts, panel layouts, halftone and speedline fills, and print-ready PNG, TIFF, PDF and CBZ export — with no downloads or installs."],
  ...
  ["Can I cancel anytime?", "Yes. Subscriptions renew automatically, but you can cancel any time from your Account page (or from PayPal) and keep access until the end of the paid period."],
  ["Is there a free trial?", "No. To keep pricing simple and honest, every plan includes everything — pick the yearly subscription, a 3- or 6-month pass, or lifetime access. You can review every feature in detail on the features page before buying, and the live demo lets you try the editor first."],

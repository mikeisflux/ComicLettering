...
import {
  ...
  FillStyle, GRADIENT_PRESETS, LAYOUT_CATEGORIES,
  LayoutRect, PAGE_SIZES, Page, PanelEl,
  COLOR_PALETTE, DPI, GradStop, MULTI_GRADIENTS,
  TAILLESS_KINDS, TextEl, TextStyle, aabbOverlap, applyCrossbarI, applyLayout,
  clamp, makeBalloon, makeImage, makePanel, makeText, newPage, normalizeRuns, runsToText,
...
import {
  BalloonPreset, Fld, HINT, LT_URL, PRESET_KEY, ProjectMeta, ProofMatch,
  STAMPS, WORD_STAMPS, displayText, domToRuns, elLabel, letterStyleCss,
  measureCharWidths, parseScript, renderRuns, runsToHtml, textCss,
} from "./editor/textHelpers";
import { closeSketchLoop, detectSketchTail, resampleRing, smoothSketchRing } from "./editor/sketch";
import { FontMenu, SubtypeSelect, tsVariant } from "./editor/FontMenu";
import { PageSetupDialog, Ruler, STAGE_MX, STAGE_MY, ToolBtn, TrayBtn } from "./editor/chrome";
import { FillPicker } from "./editor/FillPicker";
import { BalloonShape, MergeBaseInfo } from "./editor/BalloonShape";
...
export default function Editor({ demo = false }: { demo?: boolean }) {
  ...
  function resolveTailAsk(choice: "speech" | "thought" | "none") {
    const id = tailAsk;
    setTailAsk(null);
    if (!id) return;
    const d = docRef.current!;
  ...
  return (
    <div className={"app" + (demo ? " demo" : "")}>
      ...
      {tailAsk && (
        <div className="setupOverlay" onPointerDown={(e) => { if (e.target === e.currentTarget) resolveTailAsk("none"); }}>
          <div className="setupDlg" style={{ width: 330 }}>
            ...
            <div className="setupBody" style={{ flexDirection: "column", gap: 8 }}>
              <div className="tailChoices">
                <button onClick={() => resolveTailAsk("speech")}>
                ...
                <button onClick={() => resolveTailAsk("thought")}>
                ...
                <button onClick={() => resolveTailAsk("none")}>
